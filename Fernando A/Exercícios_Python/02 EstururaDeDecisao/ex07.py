...
if n1 < n2 and n1 < n3:
    print('Além disso, o menor dentre os números digitados é: ', n1,'.')

if n2 < n1 and n2 < n3:
    print('Além disso, o menor dentre os números digitados é:: ', n2,'.')

if n3 < n1 and n3 < n2:
    print('Além disso, o menor dentre os números digitados é:: ', n3,'.')